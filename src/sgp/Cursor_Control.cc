...
{
	uiCursorIndex = ReturnCursorIndex(uiCursorIndex); //Fluffy (ForeverMouseCursor)
...
//Fluffy (ForeverMouseCursor): Check if uiCursorIndex is VIDEO_DEFAULT_TO_NO_CURSOR. If so, we parse it as VIDEO_NO_CURSOR or 0 (generic cursor)
