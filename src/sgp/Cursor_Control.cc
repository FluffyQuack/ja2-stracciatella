...
{
	uiCursorIndex = ModifyCursorIndex(uiCursorIndex); //Fluffy (ForeverMouseCursor)
...
//Fluffy (ForeverMouseCursor): Checks if uiCursorIndex is VIDEO_DEFAULT_TO_NO_CURSOR. If so, we parse it as VIDEO_NO_CURSOR or 0 (generic cursor)
